      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <span
              className={`${montserrat.className} text-lg font-bold text-gray-900 dark:text-gray-100 tracking-tight`}
            >
              Juninho
            </span>
          </button>
          ...
          <div className="hidden md:flex items-center gap-2">
            {/* Langue */}
            <Button
              className="relative w-16 h-8 overflow-hidden cursor-pointer"
              variant="ghost"
              onClick={toggleLang}
            >
                ...
                {languages.map((l) => {
                  ...
                  return (
                    <motion.span
                      key={l}
                      initial={{
                        x: isActive ? 0 : isActive ? 0 : isActive ? 0 : 0,
